...
const teams = [
	{id: 1, name: 'Help', href: '#', initial: 'P', current: false},
	{id: 2, name: 'Privacy', href: '#', initial: 'P', current: false},
]
const secondaryNavigation = [
	{name: 'Themes', href: '/themes', current: true},
                                    ...
                                    {team.initial}
												...
												<li className="-mx-6 mt-auto">
													...
													>
														...
														<span aria-hidden="true">Test ORG</span>
													</a>
												</li>
											</ul>
										</nav>
					...
					<div className="flex grow flex-col gap-y-5 overflow-y-auto bg-black/10 px-6 ring-1 ring-white/5">
						...
						<nav className="flex flex-1 flex-col">
							<ul role="list" className="flex flex-1 flex-col gap-y-7">
								...
								<li>
									<div className="text-xs font-semibold leading-6 text-gray-400">Support Links</div>
									<ul role="list" className="-mx-2 mt-2 space-y-1">
										{teams.map((team) => (
											<li key={team.name}>
												<a
